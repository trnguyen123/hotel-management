...
const Dashboard = () => {
  const [stats, setStats] = useState([
    { icon: <FaUsers style={{ color: '#4361ee' }} />, title: 'Nhân viên', value: 4, description: 'Tổng số nhân viên', bgColor: 'rgba(67, 97, 238, 0.1)' },
    { icon: <FaConciergeBell style={{ color: '#f0932b' }} />, title: 'Dịch vụ', value: 0, description: 'Dịch vụ đang cung cấp', bgColor: 'rgba(240, 147, 43, 0.1)' },
    { icon: <FaTicketAlt style={{ color: '#eb4d4b' }} />, title: 'Voucher', value: 0, description: 'Voucher đang hoạt động', bgColor: 'rgba(235, 77, 75, 0.1)' },
    { icon: <FaChartBar style={{ color: '#4cc9f0' }} />, title: 'Doanh thu', value: '5.2M', description: 'Doanh thu tháng này', bgColor: 'rgba(76, 201, 240, 0.1)' }
  ]);
